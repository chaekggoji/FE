            ...
            {index === 0 ? (
              ...
              <div className='w-full flex flex-row justify-between items-center'>
                ...
                <div className='w-[25%] flex justify-end'>
                  <img src={bookClubImg} alt='Book Club Img' className='w-[20rem] object-contain' />
                </div>
              </div>
            ) : index === 1 ? (
              // 2️⃣ '책꼬지' 설명 섹션
              ...
              // 3️⃣ 활용법 섹션
              <>
                <h1 className='text-white [-webkit-text-stroke:2px_black] text-[5rem] mt-16 mb-8'><span className='text-secondary-200'>책꼬지</span> 활용하는 법</h1>
                { /* 탭 영역 */}
              ...
              <>
                { /* FAQ 제목 */}
                <h1 className='text-white [-webkit-text-stroke:2px_black] black text-[5rem] mb-8'>FAQ</h1>
